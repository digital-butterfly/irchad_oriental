...
و يسعى هذا البرنامج أيضا إلى النهوض بالتنمية الإقتصادية المحلية والإشكاليات المتعلقة بالبطالة لدى الشباب التي لا تزال مرتفعة نسبيا في المغرب."',
    ...
    '2. Appui Pré-création :'=>'2. دعم ما قبل الإنشاء',
    'Accompagner les jeunes porteurs de projets éligibles dans la préparation de leur projet, afin d’améliorer le niveau de préparation du projet et augmenter les chances de succès de leur activité (formation, appui…).'=>'مرافقة الشباب حاملي المشاريع المؤهلة في إعداد مشروعهم لتحسين مستوى إعداد المشاريع وزيادة فرص نجاح نشاطهم (التدريب والدعم ...).',
    '3. Appui à la création :'=>'3. دعم عند الإنشاء',
    'Accompagner les jeunes dans le choix des structures juridiques adaptées à leurs profiles et aux spécificités de leurs projets.'=>'دعم الشباب في اختيار الشكل القانوني الملائم لملفاتهم الشخصية والخصائص التي تنفرد بها مشاريعهم.',
    '4. Appui Post-création :'=>'4. دعم ما بعد الإنشاء',
    'Fournir un accompagnement technique aux jeunes entrepreneurs ayant effectivement démarré l’activité, pour améliorer les chances de succès de leur projet et augmenter le taux de survie des entreprises formelles créées.'=>'تقديم الدعم التقني  لحاملي المشاريع الذين بدأوا نشاطهم، من أجل تحسين فرص نجاح مشروعهم وزيادة معدل حياتها.',


    'ACCUEIL'=>'استقبال',
    'Remplir les informations de pré-inscription'=>'املأ المعلومات قبل التسجيل',
    'ORIENTATION'=>'توجيه',
    'Entretien de positionnement'=>'مقابلة أولية',
    'Validation de l’inscription'=>'التحقق من صحة التسجيل',
    'FORMATION'=>'تدريب',
    'Planifier la formation'=>'تحديد خطة التدريب',
    'Exécuter la formation'=>'تنفيد التدريب',
    'Évaluer la formation'=>'تقييم التدريب',
    'Réorienter vers l’espace de provenance'=>'إعادة التوجيه',
    'ENTREPRENARIAT'=>'إنشاء المشروع',
    'Accompagnement pré-création'=>'مرافقة قبل الإنشاء',
    'Accompagnement à la création'=>'مرافقة عند الإنشاء',
    'Accompagnement post-création'=>'مرافقة بعد الإنشاء',
