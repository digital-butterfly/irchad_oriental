...
{{--                <button type="button" class="btn btn-primary">Soumissionner un projet maintenant</button></div></div>--}}
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="feature-img mt-4">
                        <img src="images/front-office/feature-1.svg" class="img-fluid rounded" alt="">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="secound-section blue section-divider ">
        <div class="container-fluid px-5">
            <div class="row">
