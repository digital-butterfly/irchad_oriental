        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    <span class="kt-header__topbar-username kt-hidden-mobile">Mehdi</span>
                            ...
                            <div class="kt-widget__top">
                                <div class="kt-widget__content">
                                    ...
                                    <div class="kt-widget__subhead">
                                        <a href="#"><i class="flaticon2-calendar-3"></i>25/06/2020</a>                                        
                                        <a href="#"><i class="flaticon2-new-email"></i>Apiculture</a>
                                        <a href="#"><i class="flaticon2-placeholder"></i>Al Hoceima - Beni Boufrah</a>
                                    </div>
                                    <div class="kt-widget__info">
                                        <div class="kt-widget__desc">
                                            Installation de 1.000 ruches de type "Langstroth" qui peut produire 25 Kg de miel par an et par ruche. 
                                        </div>
                                        <div class="kt-widget__progress">
                                            <div class="kt-widget__text">
                                                <i class="flaticon2-calendar-3"></i> Mr Ahmed Mounim
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="kt-grid__item">
                                ...
                                <div class="kt-wizard-v1__nav">
                                    ...
                                    <div class="kt-wizard-v1__nav-items kt-wizard-v1__nav-items--clickable">
                                        <div class="kt-wizard-v1__nav-item" data-ktwizard-type="step" data-ktwizard-state="done">
