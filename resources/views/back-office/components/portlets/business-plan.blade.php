...
@php
    ...
    // Added Value
    $bp_added_value_first_year = $bp_turnover_first_year - $bp_overheads_first_year ;
    $bp_added_value_second_year = $bp_turnover_second_year - $bp_overheads_second_year ;
    $bp_added_value_third_year = $bp_turnover_third_year - $bp_overheads_third_year ;
