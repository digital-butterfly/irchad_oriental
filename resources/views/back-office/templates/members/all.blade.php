...
@section('page_content')
    <div class="kt-container  kt-grid__item kt-grid__item--fluid">
        @component('back-office.components.portlets.table', ['types' => ['En cours d\'examen', 'Validé', 'Rejeté'], 'add_link' => 'admin/members/create'])
            @slot('title')
                Adhérents
            @endslot
        @endcomponent
                    ...
                    columns: [
                        {
                            ...
                            template: function(row) {
                                var states = {
                                    'En cours d\'examen': {'title': 'Retail', 'state': 'primary'},
