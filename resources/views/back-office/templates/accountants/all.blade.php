...
@section('page_content')
    ...
    <div class="kt-container  kt-grid__item kt-grid__item--fluid">
        @component('back-office.components.portlets.table' ,['add_link' => 'admin/accountants/create'])
            @slot('title')
                Comptables
            @endslot
        @endcomponent
                ...
                var datatable = $('.kt-datatable').KTDatatable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function(row) {
                                return '\
                                <a href="admin/accountants/' + row.id + '/edit" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">\
