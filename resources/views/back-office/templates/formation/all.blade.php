...
@section('page_content')
    <div class="kt-container  kt-grid__item kt-grid__item--fluid">
        @component('back-office.components.portlets.table', [ 'add_link' => 'admin/formation/create'])
            @slot('title')
                Formation
            @endslot
        @endcomponent
   ...
   //                     saveState:false,
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            template: function(row) {
                                return '\
                                <a href="admin/formation/' + row.id + '/edit" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Edit details">\
        ...
        jQuery(document).ready(function() {
            ...
            $('.kt-datatable').on('click', '.kt-datatable__body a[title="Delete"]', function() {
                ...
                $('#kt_modal_1 .modal-body p span').html('la formation de ' + name);
