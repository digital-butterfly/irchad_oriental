  ...
  type="button"
    ...
    <div  class="page printsection print-add-break print-full-width" id="0" style="    height:21.5cm;">
      ...
      <div class="absolute left-4 top-60 space-y-5" style="width: 500px">
        ...
        >
          <h3 class="font-semibold text-xs text-right"> الإسم الكامل : {{ isset($data->company_arab->nom_arabe)?$data->company_arab->nom_arabe:''}}</h3><br>
       ...
       <div class="space-y-2 " style="margin-top:5px;">
          <div class="space-y-1">
            <h5
              ...
              style="color: var(--second-blue) ; font-size:15px;"
            >
              دراسة السوق
            </h5>
         ...
         <div class="space-y-2 " style="margin-top:5px;">
          <div class="space-y-1">
           ...
           <div class="grid grid-cols-8 md:justify-betweenp-2" dir="rtl"> 
            ...
            <div class="space-y-3 text-xs font-normal bg-gray-100">
            <p class="font-bold  text-right text-xs"style="color: var(--main-green)"> كراء المقر </p>
       ...
       <div>
        ...
        <div class="space-y-2 " dir="rtl" style="margin-top:5px;">
          <div class="space-y-1" dir="rtl">
            ...
            <hr class="bg-gray-300" style="height: 2px" />
             <div class="space-y-3 text-xs font-normal bg-gray-100 ">
             <p class="text-justify p-3 text-right text-xs" style="white-space: pre-line;"  dir="rtl">
       ...
       <div class="space-y-4 " dir="rtl" style="margin-top:5px;">
          ...
          <div class="space-y-3 text-sm font-normal">
            ...
            <p class="font-bold text-xs  col-span-3 "style="color: var(--main-green)">: الشكل القانوني</p>
             ...
             <div class="grid grid-cols-8  bg-gray-100 p-2" dir="rtl">
              <p class=" font-bold  text-xs col-span-3"style="color: var(--main-green)">المنتوج أو الخدمة </p>
              <?php  isset($data->company_arab->produit_service_arabee)?$critères=explode('-',$data->company_arab->produit_service_arabee):" ";// dd($critères);?>
                 @if (isset($critères))
                    @foreach($critères as $item)
                    @if ($item)
                    <ul class="list-inside list-disc space-y-2 text-right  col-span-5"style="margin-top:0px;">
                ...
                <tbody class="font-medium">
                  ...
                  @foreach ($data->financial_data->startup_needs as $item)
                    ...
                    <tr> 
                      ...
                      <td class="border-2 border-gray-500 w-6/12 py-1 pl-4 text-xs">{{$financial_data_arabic[$item->label]}}</td>  
                       @endif
                  </tr> 
                  @endforeach
                 @endif
